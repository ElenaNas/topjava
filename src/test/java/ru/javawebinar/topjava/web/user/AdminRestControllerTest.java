...
class AdminRestControllerTest extends AbstractControllerTest {
    ...
    void getWithMeals() throws Exception {
        MvcResult result = perform(MockMvcRequestBuilders.get(REST_URL + ADMIN_ID))
                .andExpect(status().isOk())
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
                .andReturn();

        String content = result.getResponse().getContentAsString();
        User adminWithMeals = JsonUtil.readValue(content, User.class);
    ...
    void getWithMealsNotFound() throws Exception {
        perform(MockMvcRequestBuilders.get(REST_URL + UserTestData.NOT_FOUND + "/with-meals"))
