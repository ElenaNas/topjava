...
public class MealTestData {
    ...
    public static final List<MealTo> mealsToFiltered = List.of(mealTo6, mealTo2);

    public static final List<MealTo> mealsToFilteredWithNullValues = List.of(mealTo5, mealTo4, mealTo1);
